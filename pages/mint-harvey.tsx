...
import { useMintFunction } from "../hooks/traitHooks";
...
export default function Mint() {
    ...
    const { mint, isPending } = useMintFunction();
    ...
    const handleMint = async () => {
        try {
            ...
            //     value: BigInt(Math.floor(0.021 * mintAmount * 1e18))
            // });
            await mint(mintAmount);
        } catch (error) {
                ...
                <main className="w-full border-t border-gray-300 ">
                    ...
                    <div className="mx-[20px] sm:mx-[3.45vw] "> {/* EDGES */}
                        ...
                        <section className={`border-l border-r flex flex-col items-center justify-center bg-white py-[3.45vw]`}>
                            ...
                            {!address ? (
                                <div className="text-lg">Please connect your wallet to mint</div>
                            ) : (
                                <div className="flex flex-col items-center gap-4">
                                    ...
                                    <button
                                        onClick={handleMint}
                                        disabled={isPending}
                                        className="bg-blue-500 hover:bg-blue-700 text-white source-sans-pro py-2 px-4 rounded disabled:opacity-50 disabled:cursor-not-allowed mt-4"
                                    >
                                        {isPending ? "Minting..." : (
