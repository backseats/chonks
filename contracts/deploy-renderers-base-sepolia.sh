...
forge script --rpc-url $BASE_MAINNET_RPC_URL script/ChonksMain.s.sol:ChonksRenderersScript --private-key $BASE_PRIVATE_KEY --chain-id 8453 --etherscan-api-key $BASESCAN_API_KEY --broadcast --verify -vvvv
