...
forge script --rpc-url $BASE_SEPOLIA_RPC_URL script/PetersMain.s.sol:PetersZScript --private-key $BASE_SEPOLIA_PRIVATE_KEY --chain-id 83542 --broadcast --verify -vvvv 