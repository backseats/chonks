          ...
          <>
            ...
            {!address ? (
              ...
              <div className="flex flex-col gap-2">
                <button
                  className="w-full bg-red-500 text-white py-2 px-4 hover:brightness-110 transition-colors"
            ...
            localListingSuccess ? (
              <>
                ...
                <button
                  ...
                  className="mb-4bg-white text-black border border-black px-4 py-2 text-[1vw] hover:bg-gray-100 transition-colors mt-[1.725vw]"
                >
                  Close
                </button>
              </>
            ...
            localHashListChonk ? (
                ...
                {isListChonkError ? (
                  <>
                    ...
                    <div className="text-[vw] mb-2">
                      There&apos;s been an error with your transaction. Please try again.
                    </div>
                    <button
                      onClick={() => setIsModalOpen(false)}
                      className="mb-6 bg-white text-black border border-black px-4 py-2 text-[1vw] hover:bg-gray-100 transition-colors"
                    >
                      Close
                    </button>
                  </>
              ...
              <div>
                ...
                <div className="flex justify-end space-x-4">
                  ...
                  <button
                    className="bg-chonk-blue px-4 py-2 bg-black text-white hover:brightness-110"
                    onClick={() => {
